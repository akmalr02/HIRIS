...
class AttendanceSeeder extends Seeder
{
     ...
     *
     * Membuat data absensi untuk 5 bulan (September 2025 - 9 Januari 2026) dengan variasi tinggi:
     * - 50 employees x ~84 working days = ~4200 records
     ...
     * - Monthly patterns: Sep (back to work), Oct (productive), Nov (holiday prep), Dec (holiday season), Jan (new year)
    ...
    public function run(): void
    {
        ...
        foreach ($employees as $employee) {
            ...
            foreach ($months as $monthData) {
                ...
                // Batasi data absensi Januari 2026 hanya untuk tanggal 1-9 (hari kerja awal bulan)
                ...
                } elseif ($monthData['year'] == 2026 && $monthData['month'] == 1) { // Januari 2026 - awal tahun baru
                    $monthlyFactor = 0.88; // Masih dalam suasana liburan
                    $absentRate = 10; // Masih tinggi di awal tahun (post-holiday)
                }
